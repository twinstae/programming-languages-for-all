...
<LinkCard
  title="Github - kikito/lua_missions"
  description="Lua Koans, minus the Zen stuff"
  href="https://github.com/kikito/lua_missions"
/>

<LinkCard
  title="Git book - Lua Guide"
  description="The goal of this guide is to provide a way for anybody to learn Lua, regardless of previous programming experience or knowledge of programming fundamentals."
  href="https://stigmax.gitbook.io/lua-guide/"
/>
